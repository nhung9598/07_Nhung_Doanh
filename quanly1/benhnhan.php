							...
							<?php
								...
								if(mysqli_num_rows($result) > 0){
									...
									while ($r = mysqli_fetch_assoc($result)){
										...
										echo "<td>$sdt</td>"	;
										echo "<td>$diachi</td>";
										echo " <td style='text-align: center;'> <a href='chucnang/suabn.php?id=$benhnhanid'><input id='btnSua' type='button' value='sửa' '></a> <a href='thongtinbn.php?id=$benhnhanid'><input id='btnChitiet' type='button' value='chi  tiết' '></a>  </td>";
